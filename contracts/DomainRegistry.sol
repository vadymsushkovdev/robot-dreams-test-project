...
contract DomainRegistry is IDomainRegistry {
     ...
     * @notice The owner of the contract who has administrative control. 
     */
     ...
     */
    error PriceEqualsZero(uint256 incomingValue, uint256 expectingValue);
     ...
     * @param expectingValue The expected value. 
     */
    error IncorrectValueAmount(uint256 incomingValue, uint256 expectingValue);
